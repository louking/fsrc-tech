...
- [reports/](reports/README.md) — per-race sanitized timing reports and a running cross-race summary, mostly generated by [chip-timing-analysis](https://github.com/louking/chip-timing-analysis) (a few hand-written to the same format for races that tool doesn't yet ingest)
